...
New to the project? Read the **[Step-by-Step Maze Generation Guide](docs/STEP_BY_STEP_GUIDE.md)** — a beginner-friendly walkthrough that explains the entire process from configuration to rendering, with diagrams and commented code.
